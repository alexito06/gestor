				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						...
						<div class="box-body no-padding">
								<table class="table table-bordered table-striped table-hover table-sorter table-responsive filterable" id="getSolicitudes" cellpadding="0" cellspacing="0"></table>
						</div>
